...
//we can use brute force approach but it will take time complexity of O(n*k*k) which is not feasible.
//so we use extractMax or extractMin function which has time complexity of O(logk)
